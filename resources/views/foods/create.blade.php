    ...
    @section('content')
        <div id="content-wrapper"  class="panel panel-success">
            ...
            <div class="panel-body">
                {!! Form::model($food, array('action' => array('FoodsController@store',  $food->id), 'method' => 'POST')) !!}
               ...
               <div class="form-group">
                    ...
                    {!! Form::text('food_group_id', null, array('placeholder' => 'Grupo alimenticio', 'class'=>'form-control', 'required' => 'required', 'autofocus' => 'autofocus' )) !!}
                </div>
               <div class="form-group">
               ...
               <div class="form-group">
                ...
                {!! Form::submit('Agregar', array('class' => 'btn btn-block btn-primary')) !!}
                {!! Form::close() !!}
                </div>
        </div>
    @stop
